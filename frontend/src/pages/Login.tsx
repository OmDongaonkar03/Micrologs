...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    toast({ title: "Login", description: "Auth integration coming soon." });
    navigate("/dashboard");
  };

  const handleGoogleLogin = () => {
    toast({ title: "Google Login", description: "Auth integration coming soon." });
  };
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="space-y-6">
            <div className="font-mono text-xs text-muted-foreground space-y-1">
              <p className="text-primary">$ ssh user@micrologs.dev</p>
            ...
            <h2 className="text-3xl font-light text-foreground leading-tight">
              ...
              <span className="text-primary text-glow">Own your data.</span>
            </h2>
            <p className="text-sm text-muted-foreground max-w-md leading-relaxed">
              Self-hostable, open-source analytics for developers who care about privacy and performance.
            </p>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <Link to="/login" className="text-[10px] font-mono text-primary hover:underline">
                      Forgot password?
                    </Link>
                  </div>
                  <div className="relative">
